...
#define VSYNC_ISR_INTC_VECTOR            ((reg32 *) VSYNC_ISR__INTC_VECT)
...
#define VSYNC_ISR_INTC_SET_EN            ((reg32 *) VSYNC_ISR__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the VSYNC_ISR interrupt. */
#define VSYNC_ISR_INTC_CLR_EN            ((reg32 *) VSYNC_ISR__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the VSYNC_ISR interrupt state to pending. */
#define VSYNC_ISR_INTC_SET_PD            ((reg32 *) VSYNC_ISR__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the VSYNC_ISR interrupt. */
#define VSYNC_ISR_INTC_CLR_PD            ((reg32 *) VSYNC_ISR__INTC_CLR_PD_REG)
